import { hover, motion, AnimatePresence } from "framer-motion";
  ...
  return (
    <header className="absolute w-full z-50 transition-all duration-300">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 md:h-20">
        ...
        >
          <div
            className="h-10 w-10 rounded-xl bg-gradient-to-r
        ...
        <motion.button
          ...
          className="hidden md:block ml-4 px-4 py-2 rounded-xl bg-gradient-to-r from-gray-400 to-gray-100
        ...
        <div className="md:hidden flex items-center">
          <motion.button
            whileTap={{ scale: 0.9 }}
            onClick={toggleMenu}
            className="text-gray-800 dark:text-gray-200 flex items-center justify-center"
          >
            {isOpen ? (
              <FiX className="h-6 w-6" />
            ) : (
              <FiMenu className="h-6 w-8" />
            )}
          </motion.button>
        </div>
      </div>
            ...
            {["home", "about", "projects", "experience", "contact"].map(
              (item) => (
                <a
                  ...
                  href={`#${item}`}
                  onClick={toggleMenu}
                  className="text-gray-800 dark:text-gray-300 font-medium py-2 
          ...
          shadow-xl w-full max-w-md p-6"
            >
              ...
              <form className="space-y-4">
                ...
                hover:from-violet-800 hover:to-purple-800
